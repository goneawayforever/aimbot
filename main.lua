...
--// Launching checks
if not getgenv().YNCHR or getgenv().YNCHR.Aimbot then return end
--// Services
...
local Environment = getgenv().YNCHR.Aimbot
--// Core Functions
...
getgenv().YNCHR.Aimbot.Functions = nil
getgenv().YNCHR.Aimbot = nil
